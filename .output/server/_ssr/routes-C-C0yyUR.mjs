...
import { _ as Download, a as Search, b as ArrowLeft, c as Pause, d as Lock, f as KeyRound, g as FileText, h as FolderOpen, i as Square, l as Music2, m as Folder, n as Video, o as RotateCw, p as Image, r as Upload, s as Play, t as X, u as Minus, v as ChevronRight, y as ArrowRight } from "../_libs/lucide-react.mjs";
...
function displayVideoTitle(item) {
	return item.title.replace(/\.[^.]+$/, "").replace(/[-_]+/g, " ").replace(/\b\w/g, (c) => c.toUpperCase());
}
function folderPath(folderId) {
	...
	while (current) {
		...
		current = current.parent ? FOLDERS.find((f) => f.id === current.parent) : void 0;
	}
	return parts;
}
function VideoThumbnailCard({ item, isSelected, isActive, onOpen }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [
			item.src && !item.locked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
				src: item.src,
				preload: "metadata",
				muted: true,
				playsInline: true,
				...
				onLoadedMetadata: (e) => {
					e.currentTarget.currentTime = Math.min(1, e.currentTarget.duration * .05);
				}
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-black/5" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-0 grid place-items-center",
				children: item.locked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-5 w-5 fill-current ml-0.5" })
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function VaultPage() {
	...
	const parentFolder = currentFolder.parent ? FOLDERS.find((f) => f.id === currentFolder.parent) : void 0;
	const selectedItem = selected ? allItems.find((t) => t.id === selected) : void 0;
	const activeVideoItem = activeVideo ? allItems.find((t) => t.id === activeVideo) : void 0;
	...
	const renderItemIcon = (item) => {
		if (item.locked) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
			className: "h-3.5 w-3.5",
			strokeWidth: 1.75
		});
		if (item.media === "video") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Video, {
			className: "h-3.5 w-3.5",
			strokeWidth: 1.75
		});
		if (item.media === "image") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image, {
			className: "h-3.5 w-3.5",
			strokeWidth: 1.75
		});
		if (item.media === "text") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
			className: "h-3.5 w-3.5",
			strokeWidth: 1.75
		});
	...
	const renderFolderTree = (parentId, depth = 0) => FOLDERS.filter((f) => f.parent === parentId).map((f) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [
				active ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FolderOpen, {
		...
		}), renderFolderTree(f.id, depth + 1)] }, f.id);
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
			...
			children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											"aria-label": "refresh",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RotateCw, { className: "h-3.5 w-3.5" })
										})
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "Vault"
									}), path.map((part) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "flex items-center gap-1 min-w-0",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-3 w-3 text-muted-foreground shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "truncate",
											children: part
										})]
									}, part))]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "h-3 w-3 text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "text-muted-foreground",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Folders"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", { children: renderFolderTree() })]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "min-w-0",
								children: isVideosFolder ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "min-w-0",
									children: [activeVideoItem?.src && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										}, activeVideoItem.src), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center justify-between gap-3 px-4 py-3",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "min-w-0",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "truncate text-sm font-medium",
													children: displayVideoTitle(activeVideoItem)
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [visible.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoThumbnailCard, {
													item,
									...
									imageItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: imageItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												type: "button",
											...
											return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
														...
														children: [
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
																...
																children: isPlaying ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "h-3 w-3 fill-current" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-3 w-3 fill-current ml-px" })
															}),
															/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: "text-mono text-sm truncate",
																children: t.title
															}),
															t.folder === "demos" && t.media === "audio" && t.src && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
																href: t.src,
																download: true,
															...
															isPlaying && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
																className: "inline-flex items-center gap-1 text-[10px] uppercase tracking-[0.15em] text-accent",
																children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-accent" }), "playing"]
															})
														]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														children: t.locked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
															className: "h-3 w-3",
															strokeWidth: 1.75
														}) : isPlaying ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "h-3 w-3 fill-current" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-3 w-3 fill-current ml-px" })
													})
												]
											}) }, t.id);
										}), visible.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: selectedItem?.locked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, {
								className: "h-4 w-4 text-muted-foreground",
								strokeWidth: 1.75
							}) : selectedItem?.media === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Video, {
								className: "h-4 w-4",
								strokeWidth: 1.75
							}) : selectedItem?.media === "text" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, {
								className: "h-4 w-4",
								strokeWidth: 1.75
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-mono text-sm truncate",
								children: selectedItem ? selectedItem.media === "video" ? displayVideoTitle(selectedItem) : selectedItem.title : "no file selected"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[11px] text-muted-foreground text-mono",
								children: selectedItem ? `${selectedItem.kind} · ${selectedItem.size}` : "select a track above"
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				selectedItem?.media === "text" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						})] }), joined ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "vault.exe · v0.7" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
						"© ",
